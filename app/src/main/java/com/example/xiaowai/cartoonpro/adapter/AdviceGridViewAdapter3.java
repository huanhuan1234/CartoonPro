...
public class AdviceGridViewAdapter3 extends BaseAdapter{
    private Context mContext;
    private List<DiscoverBean.DataBean.InfosBean.TopicsBean> mList;

    public AdviceGridViewAdapter3(Context context, List<DiscoverBean.DataBean.InfosBean.TopicsBean> list) {
        mContext = context;
        mList = list;
    }
